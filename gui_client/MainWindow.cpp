...
static QString darkAppStyleSheet()
{
	return
		...
		"QPushButton { background-color: #3a3a3a; color: #f0f0f0; border: 1px solid #626262; }"
		"QPushButton:hover { background-color: #464646; }"
		"QPushButton:pressed { background-color: #2f2f2f; }"
		"QPushButton:disabled { background-color: #2a2a2a; color: #8a8a8a; border: 1px solid #4c4c4c; }"
