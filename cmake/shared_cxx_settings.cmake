...
elseif(APPLE)
	...
	SET(LINUX_C_CXX_OPTIONS "-Wall -fPIC -pthread -mmmx -msse -msse2 -mssse3 -msse4.1 -std=c++14 -Wno-reorder")
	...
	SET(CMAKE_CXX_FLAGS_SDKDEBUG		"${CMAKE_CXX_FLAGS_SDKDEBUG}		${COMMON_C_CXX_OPTIONS_SDKDEBUG}")
