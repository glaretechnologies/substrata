...
void User::sendPasswordResetEmail(const EmailSendingInfo& sending_info)
{
	...
	args.contents = "To reset your " + sending_info.from_name + " password, please visit the following URL: https://" + sending_info.reset_webserver_hostname + "/reset_password_email?token=" + reset_token + " \nThis link will be valid for one hour.";
